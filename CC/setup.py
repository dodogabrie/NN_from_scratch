...
e1 = Extension('CC', ['CC.pyx'], include_dirs=[numpy.get_include(), '.'],)
...
e4 = Extension('generate_neurons', ['generate_neurons.pyx'],include_dirs=[numpy.get_include(), '.'],)
#               extra_compile_args = ["-O3", "-ffast-math", "-march=native", "-fopenmp" ],
#               extra_link_args=['-fopenmp'])

ext_modules = [e1, e2, e3, e4]
