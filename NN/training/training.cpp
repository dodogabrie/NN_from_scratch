...
/* BEGIN: Cython Metadata
{
    "distutils": {
        ...
        "sources": [
            "training/training.pyx"
        ]
    },
    "module_name": "training.training"
}
END: Cython Metadata */
...
#define __PYX_HAVE__training__training
#define __PYX_HAVE_API__training__training
/* Early includes */
#include <string.h>
#include <stdio.h>
...
static void __pyx_f_8training_8training_update_weights(struct __pyx_t_8topology_8topology_network_t); /*proto*/
static double __pyx_f_8training_8training_compute_error(struct __pyx_t_8topology_8topology_network_t, __Pyx_memviewslice); /*proto*/
...
static __Pyx_TypeInfo __Pyx_TypeInfo_nn___pyx_t_8training_8training_DOUBLE_t = { "DOUBLE_t", NULL, sizeof(__pyx_t_8training_8training_DOUBLE_t), { 0 }, 0, 'R', 0, 0 };
static __Pyx_TypeInfo __Pyx_TypeInfo_double = { "double", NULL, sizeof(double), { 0 }, 0, 'R', 0, 0 };
#define __Pyx_MODULE_NAME "training.training"
extern int __pyx_module_is_main_training__training;
int __pyx_module_is_main_training__training = 0;
...
static void __pyx_f_8training_8training_feed_input(struct __pyx_t_8topology_8topology_network_t __pyx_v_network, __Pyx_memviewslice __pyx_v_inputs) {
  int __pyx_v_i;
  struct __pyx_t_8topology_8topology_layer_t __pyx_v_first_layer;
 ...
 */
  __pyx_v_first_layer = (__pyx_v_network.lay[0]);

  /* "training/training.pyx":12
 *     cdef layer_t first_layer = network.lay[0]
 *     # Fill the firts layer neuron by neuron
 *     for i in range(first_layer.num_neu):             # <<<<<<<<<<<<<<
 ...
 * 
 */
  __pyx_t_1 = __pyx_v_first_layer.num_neu;
  __pyx_t_2 = __pyx_t_1;
  for (__pyx_t_3 = 0; __pyx_t_3 < __pyx_t_2; __pyx_t_3+=1) {
    __pyx_v_i = __pyx_t_3;

    /* "training/training.pyx":13
 *     # Fill the firts layer neuron by neuron
 *     for i in range(first_layer.num_neu):
 *         first_layer.neu[i].actv = inputs[i]             # <<<<<<<<<<<<<<
 * 
 ...
 */
    __pyx_t_4 = __pyx_v_i;
    (__pyx_v_first_layer.neu[__pyx_v_i]).actv = (*((double *) ( /* dim=0 */ (__pyx_v_inputs.data + __pyx_t_4 * __pyx_v_inputs.strides[0]) )));
  }
...
static struct __pyx_t_8topology_8topology_network_t __pyx_f_8training_8training_train(struct __pyx_t_8topology_8topology_network_t __pyx_v_network, __Pyx_memviewslice __pyx_v_inputs, __Pyx_memviewslice __pyx_v_labels, __Pyx_memviewslice __pyx_v_validation, __Pyx_memviewslice __pyx_v_labels_validation, int __pyx_v_epoch, int __pyx_v_val_data) {
  int __pyx_v_i;
  int __pyx_v_j;
  int __pyx_v_k;
  int __pyx_v_n_data;
  int __pyx_v_n_val_data;
  double __pyx_v_inv_n_data;
  double __pyx_v_inv_n_val;
  double __pyx_v_error;
  struct __pyx_t_8topology_8topology_network_t __pyx_r;
  __Pyx_RefNannyDeclarations
  size_t __pyx_t_1;
  int __pyx_t_2;
  int __pyx_t_3;
 ...
 */
  __pyx_t_1 = __Pyx_MemoryView_Len(__pyx_v_inputs); 
  __pyx_v_n_data = __pyx_t_1;

  /* "training/training.pyx":22
 *     cdef int i, j, k
 *     cdef int n_data = len(inputs)
 *     cdef int n_val_data = len(validation)             # <<<<<<<<<<<<<<
 *     cdef double inv_n_data = 1/<double>n_data
 ...
 */
  __pyx_t_1 = __Pyx_MemoryView_Len(__pyx_v_validation); 
  __pyx_v_n_val_data = __pyx_t_1;

  /* "training/training.pyx":23
 *     cdef int n_data = len(inputs)
 *     cdef int n_val_data = len(validation)
 *     cdef double inv_n_data = 1/<double>n_data             # <<<<<<<<<<<<<<
 *     cdef double inv_n_val = 1/<double>n_val_data
 ...
 */
  __pyx_v_inv_n_data = (1.0 / ((double)__pyx_v_n_data));

  /* "training/training.pyx":24
 *     cdef int n_val_data = len(validation)
 *     cdef double inv_n_data = 1/<double>n_data
 *     cdef double inv_n_val = 1/<double>n_val_data             # <<<<<<<<<<<<<<
 *     cdef double error # Temporary error for each train sample
 ...
 */
  __pyx_v_inv_n_val = (1.0 / ((double)__pyx_v_n_val_data));

  /* "training/training.pyx":27
 *     cdef double error # Temporary error for each train sample
 *     # Initialize array of errors
 ...
 */
  __pyx_v_network.train_errors = ((double *)malloc((__pyx_v_epoch * (sizeof(double)))));

  /* "training/training.pyx":28
 *     # Initialize array of errors
 *     network.train_errors = <double*>malloc(epoch*sizeof(double))
 *     network.val_errors = <double*>malloc(epoch*sizeof(double))             # <<<<<<<<<<<<<<
 *     for i in range(epoch): # for each epoch
 ...
 */
  __pyx_v_network.val_errors = ((double *)malloc((__pyx_v_epoch * (sizeof(double)))));

  /* "training/training.pyx":29
 *     network.train_errors = <double*>malloc(epoch*sizeof(double))
 *     network.val_errors = <double*>malloc(epoch*sizeof(double))
 *     for i in range(epoch): # for each epoch             # <<<<<<<<<<<<<<
 *         for j in range(n_data): # for each data
 ...
 */
  __pyx_t_2 = __pyx_v_epoch;
  __pyx_t_3 = __pyx_t_2;
  for (__pyx_t_4 = 0; __pyx_t_4 < __pyx_t_3; __pyx_t_4+=1) {
    __pyx_v_i = __pyx_t_4;

    /* "training/training.pyx":30
 *     network.val_errors = <double*>malloc(epoch*sizeof(double))
 *     for i in range(epoch): # for each epoch
 *         for j in range(n_data): # for each data             # <<<<<<<<<<<<<<
 *             feed_input(network, inputs[j])
 ...
 */
    __pyx_t_5 = __pyx_v_n_data;
    __pyx_t_6 = __pyx_t_5;
    for (__pyx_t_7 = 0; __pyx_t_7 < __pyx_t_6; __pyx_t_7+=1) {
      __pyx_v_j = __pyx_t_7;

      /* "training/training.pyx":31
 *     for i in range(epoch): # for each epoch
 *         for j in range(n_data): # for each data
 *             feed_input(network, inputs[j])             # <<<<<<<<<<<<<<
 *             forward_prop(network)
 ...
 */
      __pyx_t_8.data = __pyx_v_inputs.data;
      __pyx_t_8.memview = __pyx_v_inputs.memview;
      __PYX_INC_MEMVIEW(&__pyx_t_8, 0);
      {
    Py_ssize_t __pyx_tmp_idx = __pyx_v_j;
    Py_ssize_t __pyx_tmp_stride = __pyx_v_inputs.strides[0];
        __pyx_t_8.data += __pyx_tmp_idx * __pyx_tmp_stride;
}

__pyx_t_8.shape[0] = __pyx_v_inputs.shape[1];
__pyx_t_8.strides[0] = __pyx_v_inputs.strides[1];
    __pyx_t_8.suboffsets[0] = -1;

__pyx_f_8training_8training_feed_input(__pyx_v_network, __pyx_t_8);
      __PYX_XDEC_MEMVIEW(&__pyx_t_8, 1);
      __pyx_t_8.memview = NULL;
      __pyx_t_8.data = NULL;

      /* "training/training.pyx":32
 *         for j in range(n_data): # for each data
 *             feed_input(network, inputs[j])
 *             forward_prop(network)             # <<<<<<<<<<<<<<
 *             error += sqrt(compute_error(network, labels[j]))
 ...
 */
      __pyx_f_8training_8training_forward_prop(__pyx_v_network);

      /* "training/training.pyx":33
 *             feed_input(network, inputs[j])
 *             forward_prop(network)
 *             error += sqrt(compute_error(network, labels[j]))             # <<<<<<<<<<<<<<
 *             back_prop(network, labels[j])
...
__pyx_t_8.shape[0] = __pyx_v_labels.shape[1];
__pyx_t_8.strides[0] = __pyx_v_labels.strides[1];
    __pyx_t_8.suboffsets[0] = -1;

__pyx_v_error = (__pyx_v_error + sqrt(__pyx_f_8training_8training_compute_error(__pyx_v_network, __pyx_t_8)));
      __PYX_XDEC_MEMVIEW(&__pyx_t_8, 1);
      __pyx_t_8.memview = NULL;
      __pyx_t_8.data = NULL;

      /* "training/training.pyx":34
 *             forward_prop(network)
 *             error += sqrt(compute_error(network, labels[j]))
 *             back_prop(network, labels[j])             # <<<<<<<<<<<<<<
 *         # Batch mode: update after I see all the dataset
...
__pyx_f_8training_8training_back_prop(__pyx_v_network, __pyx_t_8);
      __PYX_XDEC_MEMVIEW(&__pyx_t_8, 1);
      __pyx_t_8.memview = NULL;
      __pyx_t_8.data = NULL;
    }

    /* "training/training.pyx":36
 *             back_prop(network, labels[j])
 *         # Batch mode: update after I see all the dataset
 *         update_weights(network)             # <<<<<<<<<<<<<<
 ...
 *         error = 0
 */
    __pyx_f_8training_8training_update_weights(__pyx_v_network);

    /* "training/training.pyx":37
 *         # Batch mode: update after I see all the dataset
 *         update_weights(network)
 *         network.train_errors[i] = error*inv_n_data             # <<<<<<<<<<<<<<
 *         error = 0
 *         if val_data:
 */
    (__pyx_v_network.train_errors[__pyx_v_i]) = (__pyx_v_error * __pyx_v_inv_n_data);

    /* "training/training.pyx":38
 *         update_weights(network)
 *         network.train_errors[i] = error*inv_n_data
 *         error = 0             # <<<<<<<<<<<<<<
 *         if val_data:
 ...
 */
    __pyx_t_9 = (__pyx_v_val_data != 0);
    if (__pyx_t_9) {

      /* "training/training.pyx":40
 *         error = 0
 *         if val_data:
 *             for k in range(n_val_data):             # <<<<<<<<<<<<<<
 *                 feed_input(network, validation[k])
 *                 forward_prop(network)
 */
      __pyx_t_5 = __pyx_v_n_val_data;
      __pyx_t_6 = __pyx_t_5;
      for (__pyx_t_7 = 0; __pyx_t_7 < __pyx_t_6; __pyx_t_7+=1) {
        __pyx_v_k = __pyx_t_7;

        /* "training/training.pyx":41
 *         if val_data:
 *             for k in range(n_val_data):
 *                 feed_input(network, validation[k])             # <<<<<<<<<<<<<<
 *                 forward_prop(network)
 ...
 */
        __pyx_t_8.data = __pyx_v_validation.data;
        __pyx_t_8.memview = __pyx_v_validation.memview;
        __PYX_INC_MEMVIEW(&__pyx_t_8, 0);
        {
    Py_ssize_t __pyx_tmp_idx = __pyx_v_k;
    Py_ssize_t __pyx_tmp_stride = __pyx_v_validation.strides[0];
        __pyx_t_8.data += __pyx_tmp_idx * __pyx_tmp_stride;
}

__pyx_t_8.shape[0] = __pyx_v_validation.shape[1];
__pyx_t_8.strides[0] = __pyx_v_validation.strides[1];
    __pyx_t_8.suboffsets[0] = -1;
 ...
 *             error = 0
 */
        __pyx_t_8.data = __pyx_v_labels_validation.data;
        __pyx_t_8.memview = __pyx_v_labels_validation.memview;
        __PYX_INC_MEMVIEW(&__pyx_t_8, 0);
        {
    Py_ssize_t __pyx_tmp_idx = __pyx_v_k;
    Py_ssize_t __pyx_tmp_stride = __pyx_v_labels_validation.strides[0];
        __pyx_t_8.data += __pyx_tmp_idx * __pyx_tmp_stride;
}

__pyx_t_8.shape[0] = __pyx_v_labels_validation.shape[1];
__pyx_t_8.strides[0] = __pyx_v_labels_validation.strides[1];
    __pyx_t_8.suboffsets[0] = -1;
 ...
 */
      (__pyx_v_network.val_errors[__pyx_v_i]) = (__pyx_v_error * __pyx_v_inv_n_val);

      /* "training/training.pyx":45
 *                 error += sqrt(compute_error(network, labels_validation[k]))
 *             network.val_errors[i] = error*inv_n_val
 *             error = 0             # <<<<<<<<<<<<<<
 *         printf("[Epoch %d]  [error %f]\r", i, network.train_errors[i])
 ...
 *     printf("\n")
 */
    (void)(printf(((char const *)"[Epoch %d]  [error %f]\r"), __pyx_v_i, (__pyx_v_network.train_errors[__pyx_v_i])));
  }

  /* "training/training.pyx":47
 *             error = 0
 *         printf("[Epoch %d]  [error %f]\r", i, network.train_errors[i])
 *     printf("Done!       \r")             # <<<<<<<<<<<<<<
 *     printf("\n")
 *     return network
 */
  (void)(printf(((char const *)"Done!       \r")));

  /* "training/training.pyx":48
 *         printf("[Epoch %d]  [error %f]\r", i, network.train_errors[i])
 *     printf("Done!       \r")
 *     printf("\n")             # <<<<<<<<<<<<<<
 *     return network
...
static __Pyx_memviewslice __pyx_f_8training_8training_predict_out(struct __pyx_t_8topology_8topology_network_t __pyx_v_network, __Pyx_memviewslice __pyx_v_data) {
  int __pyx_v_num_layers;
  int __pyx_v_i;
  int __pyx_v_j;
  int __pyx_v_n_data;
  int __pyx_v_n_out_features;
  ...
  int __pyx_clineno = 0;
  __Pyx_RefNannySetupContext("predict_out", 0);
 ...
 */
  __pyx_t_1 = __pyx_v_network.num_layers;
  __pyx_v_num_layers = __pyx_t_1;

  /* "training/training.pyx":56
 *     cdef int num_layers = network.num_layers
 *     cdef int i, j
 *     cdef int n_data = len(data)             # <<<<<<<<<<<<<<
 ...
 */
  __pyx_t_1 = (__pyx_v_network.lay[(__pyx_v_num_layers - 1)]).num_neu;
  __pyx_v_n_out_features = __pyx_t_1;

  /* "training/training.pyx":59
 *     cdef int n_out_features = network.lay[num_layers-1].num_neu
 *     # Initialize array of predictions
 *     cdef np.ndarray[DOUBLE_t, ndim=2, mode='c'] predictions = np.empty((n_data, n_out_features))             # <<<<<<<<<<<<<<
 ...
 */
  ...
  __pyx_t_5 = __Pyx_PyObject_GetAttrStr(__pyx_t_4, __pyx_n_s_empty); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 59, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_5);
  __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
  __pyx_t_4 = __Pyx_PyInt_From_int(__pyx_v_n_data); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 59, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_4);
  __pyx_t_6 = __Pyx_PyInt_From_int(__pyx_v_n_out_features); if (unlikely(!__pyx_t_6)) __PYX_ERR(0, 59, __pyx_L1_error)
  ...
  __pyx_t_8 = ((PyArrayObject *)__pyx_t_3);
  {
    ...
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_predictions.rcbuffer->pybuffer, (PyObject*)__pyx_t_8, &__Pyx_TypeInfo_nn___pyx_t_8training_8training_DOUBLE_t, PyBUF_FORMAT| PyBUF_C_CONTIGUOUS| PyBUF_WRITABLE, 2, 0, __pyx_stack) == -1)) {
  ...
  __pyx_t_8 = 0;
  __pyx_v_predictions = ((PyArrayObject *)__pyx_t_3);
  __pyx_t_3 = 0;

  /* "training/training.pyx":60
 *     # Initialize array of predictions
 *     cdef np.ndarray[DOUBLE_t, ndim=2, mode='c'] predictions = np.empty((n_data, n_out_features))
 *     for i in range(n_data):             # <<<<<<<<<<<<<<
 *         feed_input(network, data[i]) # Send in the first layer the data
...
__pyx_f_8training_8training_feed_input(__pyx_v_network, __pyx_t_11);
    __PYX_XDEC_MEMVIEW(&__pyx_t_11, 1);
    __pyx_t_11.memview = NULL;
    __pyx_t_11.data = NULL;

    /* "training/training.pyx":62
 *     for i in range(n_data):
 *         feed_input(network, data[i]) # Send in the first layer the data
 *         forward_prop(network)        # Propagate it in the net             # <<<<<<<<<<<<<<
 *         for j in range(n_out_features): # Save the result in predictions
 ...
 *     return predictions
 */
    __pyx_t_12 = __pyx_v_n_out_features;
    __pyx_t_13 = __pyx_t_12;
    for (__pyx_t_14 = 0; __pyx_t_14 < __pyx_t_13; __pyx_t_14+=1) {
      __pyx_v_j = __pyx_t_14;

      /* "training/training.pyx":64
 *         forward_prop(network)        # Propagate it in the net
 *         for j in range(n_out_features): # Save the result in predictions
 *             predictions[i, j] = network.lay[num_layers-1].neu[j].actv             # <<<<<<<<<<<<<<
 *     return predictions
 * 
 */
      __pyx_t_15 = ((__pyx_v_network.lay[(__pyx_v_num_layers - 1)]).neu[__pyx_v_j]).actv;
      __pyx_t_16 = __pyx_v_i;
      __pyx_t_17 = __pyx_v_j;
      *__Pyx_BufPtrCContig2d(__pyx_t_8training_8training_DOUBLE_t *, __pyx_pybuffernd_predictions.rcbuffer->pybuffer.buf, __pyx_t_16, __pyx_pybuffernd_predictions.diminfo[0].strides, __pyx_t_17, __pyx_pybuffernd_predictions.diminfo[1].strides) = __pyx_t_15;
    }
  }

  /* "training/training.pyx":65
 *         for j in range(n_out_features): # Save the result in predictions
 *             predictions[i, j] = network.lay[num_layers-1].neu[j].actv
 *     return predictions             # <<<<<<<<<<<<<<
 * 
 ...
 */
  __pyx_t_18 = __Pyx_PyObject_to_MemoryviewSlice_dsds_double(((PyObject *)__pyx_v_predictions), PyBUF_WRITABLE); if (unlikely(!__pyx_t_18.memview)) __PYX_ERR(0, 65, __pyx_L1_error)
  __pyx_r = __pyx_t_18;
 ...
 */
  ...
  __Pyx_AddTraceback("training.training.predict_out", __pyx_clineno, __pyx_lineno, __pyx_filename);
  goto __pyx_L2;
  __pyx_L0:;
  __Pyx_SafeReleaseBuffer(&__pyx_pybuffernd_predictions.rcbuffer->pybuffer);
...
static void __pyx_f_8training_8training_forward_prop(struct __pyx_t_8topology_8topology_network_t __pyx_v_network) {
  int __pyx_v_i;
  int __pyx_v_j;
  int __pyx_v_k;
  int __pyx_v_num_layers;
  double __pyx_v_xw;
  struct __pyx_t_8topology_8topology_layer_t __pyx_v_lay_here;
  struct __pyx_t_8topology_8topology_layer_t __pyx_v_lay_prev;
  __Pyx_RefNannyDeclarations
  int __pyx_t_1;
  int __pyx_t_2;
  int __pyx_t_3;
 ...
 */
    __pyx_v_lay_here = (__pyx_v_network.lay[__pyx_v_i]);

    /* "training/training.pyx":74
 *     for i in range(1, num_layers): # for each layer
 *         lay_here = network.lay[i] # store actual layer (just for compat code)
 *         lay_prev = network.lay[i-1] # store previous layer (just for compact code)             # <<<<<<<<<<<<<<
 *         for j in range(lay_here.num_neu): # for each neuron of acutual layer
 ...
 */
    __pyx_v_lay_prev = (__pyx_v_network.lay[(__pyx_v_i - 1)]);

    /* "training/training.pyx":75
 *         lay_here = network.lay[i] # store actual layer (just for compat code)
 *         lay_prev = network.lay[i-1] # store previous layer (just for compact code)
 *         for j in range(lay_here.num_neu): # for each neuron of acutual layer             # <<<<<<<<<<<<<<
 *             lay_here.neu[j].net = lay_here.neu[j].bias # First add bias to the net
 ...
 */
    __pyx_t_4 = __pyx_v_lay_here.num_neu;
    __pyx_t_5 = __pyx_t_4;
    for (__pyx_t_6 = 0; __pyx_t_6 < __pyx_t_5; __pyx_t_6+=1) {
      __pyx_v_j = __pyx_t_6;

      /* "training/training.pyx":76
 *         lay_prev = network.lay[i-1] # store previous layer (just for compact code)
 *         for j in range(lay_here.num_neu): # for each neuron of acutual layer
 *             lay_here.neu[j].net = lay_here.neu[j].bias # First add bias to the net             # <<<<<<<<<<<<<<
 *             for k in range(lay_prev.num_neu): # For each neuron of previus layer
 ...
 */
      __pyx_t_7 = (__pyx_v_lay_here.neu[__pyx_v_j]).bias;
      (__pyx_v_lay_here.neu[__pyx_v_j]).net = __pyx_t_7;

      /* "training/training.pyx":77
 *         for j in range(lay_here.num_neu): # for each neuron of acutual layer
 *             lay_here.neu[j].net = lay_here.neu[j].bias # First add bias to the net
 *             for k in range(lay_prev.num_neu): # For each neuron of previus layer             # <<<<<<<<<<<<<<
 *                 # Select the w of the connection j of the neuron k (prevoius
 ...
 */
      __pyx_t_8 = __pyx_v_lay_prev.num_neu;
      __pyx_t_9 = __pyx_t_8;
      for (__pyx_t_10 = 0; __pyx_t_10 < __pyx_t_9; __pyx_t_10+=1) {
        __pyx_v_k = __pyx_t_10;

        /* "training/training.pyx":80
 *                 # Select the w of the connection j of the neuron k (prevoius
 *                 # layer) and multiply it by the out of that neuron (wk * xk)
 ...
 */
        __pyx_v_xw = (((__pyx_v_lay_prev.neu[__pyx_v_k]).out_weights[__pyx_v_j]) * (__pyx_v_lay_prev.neu[__pyx_v_k]).actv);

        /* "training/training.pyx":82
 *                 xw = lay_prev.neu[k].out_weights[j] * lay_prev.neu[k].actv
 *                 # implement sum_k(wk*xk) relative to neuron j (actual layer)
 *                 lay_here.neu[j].net += xw             # <<<<<<<<<<<<<<
 ...
 */
        ...
        (__pyx_v_lay_here.neu[__pyx_t_11]).net = ((__pyx_v_lay_here.neu[__pyx_t_11]).net + __pyx_v_xw);
      }

      /* "training/training.pyx":85
 *             # Update the output of the actual neuron with the activation
 *             # function on the net
 ...
 * @cython.boundscheck(False)  # Deactivate bounds checking
 */
      (__pyx_v_lay_here.neu[__pyx_v_j]).actv = __pyx_v_lay_here.activation_f((__pyx_v_lay_here.neu[__pyx_v_j]).net);
    }
  }
...
static void __pyx_f_8training_8training_back_prop(struct __pyx_t_8topology_8topology_network_t __pyx_v_network, __Pyx_memviewslice __pyx_v_labels) {
  int __pyx_v_i;
  int __pyx_v_j;
  int __pyx_v_k;
  int __pyx_v_rev;
  int __pyx_v_num_layers;
  struct __pyx_t_8topology_8topology_layer_t __pyx_v_lay;
  struct __pyx_t_8topology_8topology_layer_t __pyx_v_lay_back;
  __Pyx_RefNannyDeclarations
  int __pyx_t_1;
  int __pyx_t_2;
  int __pyx_t_3;
 ...
 * 
 */
  __pyx_v_lay = (__pyx_v_network.lay[(__pyx_v_num_layers - 1)]);

  /* "training/training.pyx":93
 *     cdef int num_layers = network.num_layers
 *     cdef layer_t lay = network.lay[num_layers-1]
 *     cdef layer_t lay_back = network.lay[num_layers-2]             # <<<<<<<<<<<<<<
 * 
 *     ### Last Layer ###
 */
  __pyx_v_lay_back = (__pyx_v_network.lay[(__pyx_v_num_layers - 2)]);

  /* "training/training.pyx":96
 * 
 *     ### Last Layer ###
 ...
 */
  __pyx_t_1 = __pyx_v_lay.num_neu;
  __pyx_t_2 = __pyx_t_1;
  for (__pyx_t_3 = 0; __pyx_t_3 < __pyx_t_2; __pyx_t_3+=1) {
    __pyx_v_j = __pyx_t_3;

    /* "training/training.pyx":98
 *     for j in range(lay.num_neu): # For each neuron of last layer
 *         # Compute the delta: (d-o)*f'(net)
 *         lay.neu[j].dnet = (labels[j] - lay.neu[j].actv) * lay.derivative_f(lay.neu[j].net)             # <<<<<<<<<<<<<<
 ...
 */
    __pyx_t_4 = __pyx_v_j;
    (__pyx_v_lay.neu[__pyx_v_j]).dnet = (((*((double *) ( /* dim=0 */ (__pyx_v_labels.data + __pyx_t_4 * __pyx_v_labels.strides[0]) ))) - (__pyx_v_lay.neu[__pyx_v_j]).actv) * __pyx_v_lay.derivative_f((__pyx_v_lay.neu[__pyx_v_j]).net));

    /* "training/training.pyx":99
 *         # Compute the delta: (d-o)*f'(net)
 *         lay.neu[j].dnet = (labels[j] - lay.neu[j].actv) * lay.derivative_f(lay.neu[j].net)
 *         for k in range(lay_back.num_neu): # for each neuron of prev. layer             # <<<<<<<<<<<<<<
 *             # Compute dw_back: delta*input = delta*out_prev
 ...
 */
    __pyx_t_5 = __pyx_v_lay_back.num_neu;
    __pyx_t_6 = __pyx_t_5;
    for (__pyx_t_7 = 0; __pyx_t_7 < __pyx_t_6; __pyx_t_7+=1) {
      __pyx_v_k = __pyx_t_7;

      /* "training/training.pyx":101
 *         for k in range(lay_back.num_neu): # for each neuron of prev. layer
 *             # Compute dw_back: delta*input = delta*out_prev
 *             lay_back.neu[k].dw[j] += lay.neu[j].dnet * lay_back.neu[k].actv             # <<<<<<<<<<<<<<
 ...
 */
      __pyx_t_8 = __pyx_v_k;
      __pyx_t_9 = __pyx_v_j;
      ((__pyx_v_lay_back.neu[__pyx_t_8]).dw[__pyx_t_9]) = (((__pyx_v_lay_back.neu[__pyx_t_8]).dw[__pyx_t_9]) + ((__pyx_v_lay.neu[__pyx_v_j]).dnet * (__pyx_v_lay_back.neu[__pyx_v_k]).actv));

      /* "training/training.pyx":103
 *             lay_back.neu[k].dw[j] += lay.neu[j].dnet * lay_back.neu[k].actv
 *             # Store the value w_prev * delta for next steps
 *             lay_back.neu[k].dactv += lay_back.neu[k].out_weights[j] * lay.neu[j].dnet             # <<<<<<<<<<<<<<
 ...
 */
      __pyx_t_8 = __pyx_v_k;
      (__pyx_v_lay_back.neu[__pyx_t_8]).dactv = ((__pyx_v_lay_back.neu[__pyx_t_8]).dactv + (((__pyx_v_lay_back.neu[__pyx_v_k]).out_weights[__pyx_v_j]) * (__pyx_v_lay.neu[__pyx_v_j]).dnet));
    }

    /* "training/training.pyx":105
 *             lay_back.neu[k].dactv += lay_back.neu[k].out_weights[j] * lay.neu[j].dnet
 *         # Compute dbias just like delta * x0_prev = delta
 *         lay.neu[j].dbias += lay.neu[j].dnet             # <<<<<<<<<<<<<<
 *     ##################
 ...
 */
    __pyx_t_5 = __pyx_v_j;
    (__pyx_v_lay.neu[__pyx_t_5]).dbias = ((__pyx_v_lay.neu[__pyx_t_5]).dbias + (__pyx_v_lay.neu[__pyx_v_j]).dnet);
  }

  /* "training/training.pyx":109
 * 
 *     ### Inner Layers ###
 ...
 */
  __pyx_t_10 = (__pyx_v_network.num_layers - 2);
  __pyx_t_11 = __pyx_t_10;
  for (__pyx_t_1 = 0; __pyx_t_1 < __pyx_t_11; __pyx_t_1+=1) {
    __pyx_v_i = __pyx_t_1;

    /* "training/training.pyx":111
 *     for i in range(network.num_layers-2):
 *         # rev goes from num_layers - 2 to 1
 *         rev = num_layers - 2 - i # Reversed range does not exist in cython             # <<<<<<<<<<<<<<
 ...
 */
    __pyx_v_rev = ((__pyx_v_num_layers - 2) - __pyx_v_i);

    /* "training/training.pyx":112
 *         # rev goes from num_layers - 2 to 1
 *         rev = num_layers - 2 - i # Reversed range does not exist in cython
 *         lay = network.lay[rev] # actual layer             # <<<<<<<<<<<<<<
 *         lay_back = network.lay[rev-1] # previous layer
 ...
 */
    __pyx_v_lay = (__pyx_v_network.lay[__pyx_v_rev]);

    /* "training/training.pyx":113
 *         rev = num_layers - 2 - i # Reversed range does not exist in cython
 *         lay = network.lay[rev] # actual layer
 *         lay_back = network.lay[rev-1] # previous layer             # <<<<<<<<<<<<<<
 *         for j in range(lay.num_neu): # for each neu in actual layer
 ...
 */
    __pyx_v_lay_back = (__pyx_v_network.lay[(__pyx_v_rev - 1)]);

    /* "training/training.pyx":114
 *         lay = network.lay[rev] # actual layer
 *         lay_back = network.lay[rev-1] # previous layer
 *         for j in range(lay.num_neu): # for each neu in actual layer             # <<<<<<<<<<<<<<
 *             # KEY OF ALGORITHM: compute next delta based on the previous values
 ...
 */
    __pyx_t_2 = __pyx_v_lay.num_neu;
    __pyx_t_3 = __pyx_t_2;
    for (__pyx_t_5 = 0; __pyx_t_5 < __pyx_t_3; __pyx_t_5+=1) {
      __pyx_v_j = __pyx_t_5;

      /* "training/training.pyx":118
 *             # w_here * delta_backprop * f'(net)
 ...
 */
      (__pyx_v_lay.neu[__pyx_v_j]).dnet = ((__pyx_v_lay.neu[__pyx_v_j]).dactv * __pyx_v_lay.derivative_f((__pyx_v_lay.neu[__pyx_v_j]).net));

      /* "training/training.pyx":119
 *             # (delta_backprop * w_here) will be updated below in the loop of k
 *             lay.neu[j].dnet = lay.neu[j].dactv * lay.derivative_f(lay.neu[j].net)
 *             for k in range(lay_back.num_neu): # for each neuron in prev. lay.             # <<<<<<<<<<<<<<
 *                 # Update the dw_back : delta*out_prev
 ...
 */
      __pyx_t_6 = __pyx_v_lay_back.num_neu;
      __pyx_t_7 = __pyx_t_6;
      for (__pyx_t_8 = 0; __pyx_t_8 < __pyx_t_7; __pyx_t_8+=1) {
        __pyx_v_k = __pyx_t_8;

        /* "training/training.pyx":121
 *             for k in range(lay_back.num_neu): # for each neuron in prev. lay.
 *                 # Update the dw_back : delta*out_prev
 *                 lay_back.neu[k].dw[j] += lay_back.neu[k].actv * lay.neu[j].dnet             # <<<<<<<<<<<<<<
 ...
 */
        ...
        ((__pyx_v_lay_back.neu[__pyx_t_9]).dw[__pyx_t_12]) = (((__pyx_v_lay_back.neu[__pyx_t_9]).dw[__pyx_t_12]) + ((__pyx_v_lay_back.neu[__pyx_v_k]).actv * (__pyx_v_lay.neu[__pyx_v_j]).dnet));

        /* "training/training.pyx":122
 *                 # Update the dw_back : delta*out_prev
 *                 lay_back.neu[k].dw[j] += lay_back.neu[k].actv * lay.neu[j].dnet
 *                 if rev > 1: # if after this layer there isn't the imputs             # <<<<<<<<<<<<<<
 *                     # Store the value of delta * w_prev for the next step
 *                     lay_back.neu[k].dactv += lay_back.neu[k].out_weights[j] * lay.neu[j].dnet
 */
        __pyx_t_13 = ((__pyx_v_rev > 1) != 0);
        if (__pyx_t_13) {

          /* "training/training.pyx":124
 *                 if rev > 1: # if after this layer there isn't the imputs
 *                     # Store the value of delta * w_prev for the next step
 *                     lay_back.neu[k].dactv += lay_back.neu[k].out_weights[j] * lay.neu[j].dnet             # <<<<<<<<<<<<<<
 ...
 */
          __pyx_t_9 = __pyx_v_k;
          (__pyx_v_lay_back.neu[__pyx_t_9]).dactv = ((__pyx_v_lay_back.neu[__pyx_t_9]).dactv + (((__pyx_v_lay_back.neu[__pyx_v_k]).out_weights[__pyx_v_j]) * (__pyx_v_lay.neu[__pyx_v_j]).dnet));
 ...
 */
      __pyx_t_6 = __pyx_v_j;
      (__pyx_v_lay.neu[__pyx_t_6]).dbias = ((__pyx_v_lay.neu[__pyx_t_6]).dbias + (__pyx_v_lay.neu[__pyx_v_j]).dnet);

      /* "training/training.pyx":127
 *             # Compute dbias just like delta * x0_prev (= delta * 1 = delta )
 *             lay.neu[j].dbias += lay.neu[j].dnet
 *             lay.neu[j].dactv = 0. # reset the sum(delta * w) to zero (for next training)             # <<<<<<<<<<<<<<
 *     ####################
 * 
 */
      (__pyx_v_lay.neu[__pyx_v_j]).dactv = 0.;
    }
  }
...
static void __pyx_f_8training_8training_update_weights(struct __pyx_t_8topology_8topology_network_t __pyx_v_network) {
  int __pyx_v_i;
  int __pyx_v_j;
  int __pyx_v_k;
  struct __pyx_t_8topology_8topology_layer_t __pyx_v_lay;
 ...
 */
  __pyx_t_1 = (__pyx_v_network.num_layers - 1);
  __pyx_t_2 = __pyx_t_1;
  for (__pyx_t_3 = 0; __pyx_t_3 < __pyx_t_2; __pyx_t_3+=1) {
    __pyx_v_i = __pyx_t_3;

    /* "training/training.pyx":134
 *     cdef layer_t layer
 *     for i in range(network.num_layers-1): # for each layer (not the last)
 *         lay = network.lay[i] # store the layer (compact code)             # <<<<<<<<<<<<<<
 *         for j in range(lay.num_neu): # for each neuron in the layer
 ...
 */
    __pyx_v_lay = (__pyx_v_network.lay[__pyx_v_i]);

    /* "training/training.pyx":135
 *     for i in range(network.num_layers-1): # for each layer (not the last)
 *         lay = network.lay[i] # store the layer (compact code)
 *         for j in range(lay.num_neu): # for each neuron in the layer             # <<<<<<<<<<<<<<
 *             for k in range(network.lay[i+1].num_neu): # for neu in the next lay
 ...
 */
    __pyx_t_4 = __pyx_v_lay.num_neu;
    __pyx_t_5 = __pyx_t_4;
    for (__pyx_t_6 = 0; __pyx_t_6 < __pyx_t_5; __pyx_t_6+=1) {
      __pyx_v_j = __pyx_t_6;

      /* "training/training.pyx":136
 *         lay = network.lay[i] # store the layer (compact code)
 *         for j in range(lay.num_neu): # for each neuron in the layer
 *             for k in range(network.lay[i+1].num_neu): # for neu in the next lay             # <<<<<<<<<<<<<<
 *                 # update the w_k of neuron j adding eta * dw_k (repeated for
 *                 # each k)
 */
      __pyx_t_7 = (__pyx_v_network.lay[(__pyx_v_i + 1)]).num_neu;
      __pyx_t_8 = __pyx_t_7;
      for (__pyx_t_9 = 0; __pyx_t_9 < __pyx_t_8; __pyx_t_9+=1) {
        __pyx_v_k = __pyx_t_9;

        /* "training/training.pyx":139
 *                 # update the w_k of neuron j adding eta * dw_k (repeated for
 *                 # each k)
 ...
 *                 lay.neu[j].dw[k] = 0.
 */
        ((__pyx_v_lay.neu[__pyx_t_10]).out_weights[__pyx_t_11]) = (((__pyx_v_lay.neu[__pyx_t_10]).out_weights[__pyx_t_11]) + ((__pyx_v_network.eta * ((__pyx_v_lay.neu[__pyx_v_j]).dw[__pyx_v_k])) - ((2.0 * __pyx_v_network.l) * ((__pyx_v_lay.neu[__pyx_v_j]).out_weights[__pyx_v_k]))));

        /* "training/training.pyx":142
 *                                              - 2 * network.l * lay.neu[j].out_weights[k]
 *                 # restore dw (for online mode)
 *                 lay.neu[j].dw[k] = 0.             # <<<<<<<<<<<<<<
 ...
 */
        ((__pyx_v_lay.neu[__pyx_v_j]).dw[__pyx_v_k]) = 0.;
      }

      /* "training/training.pyx":144
 *                 lay.neu[j].dw[k] = 0.
 *             # update the bias like eta*dbias_j
 *             lay.neu[j].bias += network.eta * lay.neu[j].dbias \             # <<<<<<<<<<<<<<
 ...
 *             lay.neu[j].dbias = 0.
 */
      (__pyx_v_lay.neu[__pyx_t_7]).bias = ((__pyx_v_lay.neu[__pyx_t_7]).bias + ((__pyx_v_network.eta * (__pyx_v_lay.neu[__pyx_v_j]).dbias) - ((2.0 * __pyx_v_network.l) * (__pyx_v_lay.neu[__pyx_v_j]).bias)));

      /* "training/training.pyx":147
 *                                - 2 * network.l * lay.neu[j].bias
 *             # restore dbias (for online mode)
 *             lay.neu[j].dbias = 0.             # <<<<<<<<<<<<<<
 *     # last layer
 ...
 */
      (__pyx_v_lay.neu[__pyx_v_j]).dbias = 0.;
    }
  }

  /* "training/training.pyx":149
 *             lay.neu[j].dbias = 0.
 *     # last layer
 *     lay = network.lay[network.num_layers-1]             # <<<<<<<<<<<<<<
 ...
 */
  __pyx_v_lay = (__pyx_v_network.lay[(__pyx_v_network.num_layers - 1)]);

  /* "training/training.pyx":150
 *     # last layer
 *     lay = network.lay[network.num_layers-1]
 *     for j in range(lay.num_neu): # for each neuron in the last layer             # <<<<<<<<<<<<<<
 *         # update only the bias (out_weights are not needed)
 *         lay.neu[j].bias += network.eta * lay.neu[j].dbias \
 */
  __pyx_t_3 = __pyx_v_lay.num_neu;
  __pyx_t_4 = __pyx_t_3;
  for (__pyx_t_5 = 0; __pyx_t_5 < __pyx_t_4; __pyx_t_5+=1) {
    __pyx_v_j = __pyx_t_5;

    /* "training/training.pyx":152
 *     for j in range(lay.num_neu): # for each neuron in the last layer
 *         # update only the bias (out_weights are not needed)
 *         lay.neu[j].bias += network.eta * lay.neu[j].dbias \             # <<<<<<<<<<<<<<
 *                            - 2 * network.l * lay.neu[j].bias
 ...
 *         lay.neu[j].dbias = 0.
 */
    (__pyx_v_lay.neu[__pyx_t_6]).bias = ((__pyx_v_lay.neu[__pyx_t_6]).bias + ((__pyx_v_network.eta * (__pyx_v_lay.neu[__pyx_v_j]).dbias) - ((2.0 * __pyx_v_network.l) * (__pyx_v_lay.neu[__pyx_v_j]).bias)));

    /* "training/training.pyx":155
 *                            - 2 * network.l * lay.neu[j].bias
 *         # restore dbias (for online mode)
 *         lay.neu[j].dbias = 0.             # <<<<<<<<<<<<<<
 * 
...
static double __pyx_f_8training_8training_compute_error(struct __pyx_t_8topology_8topology_network_t __pyx_v_network, __Pyx_memviewslice __pyx_v_labels) {
  double __pyx_v_error_single;
  double __pyx_v_sum_error;
  double __pyx_v_quadratic_error;
  int __pyx_v_i;
  int __pyx_v_num_layers;
  double __pyx_r;
  __Pyx_RefNannyDeclarations
  ...
  int __pyx_t_3;
  Py_ssize_t __pyx_t_4;
  __Pyx_RefNannySetupContext("compute_error", 0);

  /* "training/training.pyx":160
 * @cython.wraparound(False)   # Deactivate negative indexing.
 * cdef double compute_error(network_t network, double[:] labels):
 *     cdef double error_single, sum_error = 0, quadratic_error             # <<<<<<<<<<<<<<
 *     cdef int i, num_layers = network.num_layers
 ...
 */
    __pyx_t_4 = __pyx_v_i;
    __pyx_v_error_single = ((*((double *) ( /* dim=0 */ (__pyx_v_labels.data + __pyx_t_4 * __pyx_v_labels.strides[0]) ))) - ((__pyx_v_network.lay[(__pyx_v_num_layers - 1)]).neu[__pyx_v_i]).actv);

    /* "training/training.pyx":164
 *     for i in range(network.lay[num_layers-1].num_neu):
 *         error_single = labels[i] - network.lay[num_layers-1].neu[i].actv
 *         quadratic_error = error_single*error_single             # <<<<<<<<<<<<<<
 *         sum_error += quadratic_error
 *     return sum_error
 */
    __pyx_v_quadratic_error = (__pyx_v_error_single * __pyx_v_error_single);

    /* "training/training.pyx":165
 *         error_single = labels[i] - network.lay[num_layers-1].neu[i].actv
 *         quadratic_error = error_single*error_single
 *         sum_error += quadratic_error             # <<<<<<<<<<<<<<
 *     return sum_error
 * 
 */
    __pyx_v_sum_error = (__pyx_v_sum_error + __pyx_v_quadratic_error);
  }

  /* "training/training.pyx":166
 *         quadratic_error = error_single*error_single
 *         sum_error += quadratic_error
 *     return sum_error             # <<<<<<<<<<<<<<
 * 
 */
  __pyx_r = __pyx_v_sum_error;
  goto __pyx_L0;
...
static PyTypeObject __pyx_type___pyx_array = {
  ...
  "training.training.array", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_MemviewEnum = {
  PyVarObject_HEAD_INIT(0, 0)
  "training.training.Enum", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryview = {
  PyVarObject_HEAD_INIT(0, 0)
  "training.training.memoryview", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryviewslice = {
  PyVarObject_HEAD_INIT(0, 0)
  "training.training._memoryviewslice", /*tp_name*/
...
static int __Pyx_modinit_function_export_code(void) {
  ...
  if (__Pyx_ExportFunction("feed_input", (void (*)(void))__pyx_f_8training_8training_feed_input, "void (struct __pyx_t_8topology_8topology_network_t, __Pyx_memviewslice)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("forward_prop", (void (*)(void))__pyx_f_8training_8training_forward_prop, "void (struct __pyx_t_8topology_8topology_network_t)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("update_weights", (void (*)(void))__pyx_f_8training_8training_update_weights, "void (struct __pyx_t_8topology_8topology_network_t)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("compute_error", (void (*)(void))__pyx_f_8training_8training_compute_error, "double (struct __pyx_t_8topology_8topology_network_t, __Pyx_memviewslice)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("back_prop", (void (*)(void))__pyx_f_8training_8training_back_prop, "void (struct __pyx_t_8topology_8topology_network_t, __Pyx_memviewslice)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("train", (void (*)(void))__pyx_f_8training_8training_train, "struct __pyx_t_8topology_8topology_network_t (struct __pyx_t_8topology_8topology_network_t, __Pyx_memviewslice, __Pyx_memviewslice, __Pyx_memviewslice, __Pyx_memviewslice, int, int)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("predict_out", (void (*)(void))__pyx_f_8training_8training_predict_out, "__Pyx_memviewslice (struct __pyx_t_8topology_8topology_network_t, __Pyx_memviewslice)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  __Pyx_RefNannyFinishContext();
  return 0;
  __pyx_L1_error:;
  __Pyx_RefNannyFinishContext();
...
if (!__Pyx_RefNanny) {
  ...
  #endif
  if (__pyx_module_is_main_training__training) {
    if (PyObject_SetAttr(__pyx_m, __pyx_n_s_name_2, __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "training.training")) {
      if (unlikely(PyDict_SetItemString(modules, "training.training", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init training.training", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_CLEAR(__pyx_m);
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init training.training");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
