...
/* BEGIN: Cython Metadata
{
    "distutils": {
        ...
        "sources": [
            "topology/topology.pyx"
        ]
    },
    "module_name": "topology.topology"
}
END: Cython Metadata */
...
#define __PYX_HAVE__topology__topology
#define __PYX_HAVE_API__topology__topology
/* Early includes */
#include <string.h>
#include <stdio.h>
...
static struct __pyx_t_8topology_8topology_layer_t __pyx_f_8topology_8topology_create_layer(int, __pyx_t_8topology_8topology_f_type, __pyx_t_8topology_8topology_f_type); /*proto*/
...
static __Pyx_TypeInfo __Pyx_TypeInfo_nn___pyx_t_8topology_8topology_DOUBLE_t = { "DOUBLE_t", NULL, sizeof(__pyx_t_8topology_8topology_DOUBLE_t), { 0 }, 0, 'R', 0, 0 };
#define __Pyx_MODULE_NAME "topology.topology"
extern int __pyx_module_is_main_topology__topology;
int __pyx_module_is_main_topology__topology = 0;

/* Implementation of 'topology.topology' */
...
static const char __pyx_k_Activation_func_not_valid[] = "Activation func not valid";
...
static PyObject *__pyx_kp_s_Activation_func_not_valid;
...
static struct __pyx_t_8topology_8topology_neuron_t __pyx_f_8topology_8topology_create_neuron(int __pyx_v_num_out_weights, double __pyx_v_w_init) {
  struct __pyx_t_8topology_8topology_neuron_t __pyx_v_neu;
  PyArrayObject *__pyx_v_rnd_num = 0;
  int __pyx_v_i;
  __Pyx_LocalBuf_ND __pyx_pybuffernd_rnd_num;
  __Pyx_Buffer __pyx_pybuffer_rnd_num;
  struct __pyx_t_8topology_8topology_neuron_t __pyx_r;
  ...
  int __pyx_clineno = 0;
  __Pyx_RefNannySetupContext("create_neuron", 0);
  __pyx_pybuffer_rnd_num.pybuffer.buf = NULL;
  __pyx_pybuffer_rnd_num.refcount = 0;
  __pyx_pybuffernd_rnd_num.data = NULL;
  __pyx_pybuffernd_rnd_num.rcbuffer = &__pyx_pybuffer_rnd_num;

  /* "topology/topology.pyx":10
 *     cdef int i
 ...
 */
  ...
  __pyx_t_1 = __Pyx_PyObject_GetAttrStr(__pyx_t_2, __pyx_n_s_uniform); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 10, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  __pyx_t_2 = PyFloat_FromDouble((-__pyx_v_w_init)); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 10, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  __pyx_t_3 = PyFloat_FromDouble(__pyx_v_w_init); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 10, __pyx_L1_error)
  ...
  __Pyx_GOTREF(__pyx_t_3);
  __pyx_t_2 = __Pyx_PyInt_From_long((__pyx_v_num_out_weights + 1)); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 10, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  if (PyDict_SetItem(__pyx_t_3, __pyx_n_s_size, __pyx_t_2) < 0) __PYX_ERR(0, 10, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  __pyx_t_2 = __Pyx_PyObject_Call(__pyx_t_1, __pyx_t_4, __pyx_t_3); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 10, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  ...
  __pyx_t_5 = ((PyArrayObject *)__pyx_t_2);
  {
    ...
    __Pyx_SafeReleaseBuffer(&__pyx_pybuffernd_rnd_num.rcbuffer->pybuffer);
    __pyx_t_6 = __Pyx_GetBufferAndValidate(&__pyx_pybuffernd_rnd_num.rcbuffer->pybuffer, (PyObject*)__pyx_t_5, &__Pyx_TypeInfo_nn___pyx_t_8topology_8topology_DOUBLE_t, PyBUF_FORMAT| PyBUF_C_CONTIGUOUS, 1, 0, __pyx_stack);
    if (unlikely(__pyx_t_6 < 0)) {
      PyErr_Fetch(&__pyx_t_7, &__pyx_t_8, &__pyx_t_9);
      if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_rnd_num.rcbuffer->pybuffer, (PyObject*)__pyx_v_rnd_num, &__Pyx_TypeInfo_nn___pyx_t_8topology_8topology_DOUBLE_t, PyBUF_FORMAT| PyBUF_C_CONTIGUOUS, 1, 0, __pyx_stack) == -1)) {
    ...
    __pyx_pybuffernd_rnd_num.diminfo[0].strides = __pyx_pybuffernd_rnd_num.rcbuffer->pybuffer.strides[0]; __pyx_pybuffernd_rnd_num.diminfo[0].shape = __pyx_pybuffernd_rnd_num.rcbuffer->pybuffer.shape[0];
    if (unlikely(__pyx_t_6 < 0)) __PYX_ERR(0, 10, __pyx_L1_error)
  }
  __pyx_t_5 = 0;
  __pyx_v_rnd_num = ((PyArrayObject *)__pyx_t_2);
  __pyx_t_2 = 0;

  /* "topology/topology.pyx":11
 *     # Define weights and bias ###########
 *     rnd_num = np.random.uniform(-w_init,w_init, size = num_out_weights + 1) # array for rnd weights
 *     neu.out_weights = <double*>malloc(num_out_weights * sizeof(double))             # <<<<<<<<<<<<<<
 *     for i in range(num_out_weights):
 ...
 */
  __pyx_v_neu.out_weights = ((double *)malloc((__pyx_v_num_out_weights * (sizeof(double)))));

  /* "topology/topology.pyx":12
 *     rnd_num = np.random.uniform(-w_init,w_init, size = num_out_weights + 1) # array for rnd weights
 *     neu.out_weights = <double*>malloc(num_out_weights * sizeof(double))
 *     for i in range(num_out_weights):             # <<<<<<<<<<<<<<
 *         neu.out_weights[i] = rnd_num[i]
 ...
 */
  __pyx_t_6 = __pyx_v_num_out_weights;
  __pyx_t_10 = __pyx_t_6;
  for (__pyx_t_11 = 0; __pyx_t_11 < __pyx_t_10; __pyx_t_11+=1) {
    __pyx_v_i = __pyx_t_11;

    /* "topology/topology.pyx":13
 *     neu.out_weights = <double*>malloc(num_out_weights * sizeof(double))
 *     for i in range(num_out_weights):
 *         neu.out_weights[i] = rnd_num[i]             # <<<<<<<<<<<<<<
 *     neu.dw = <double*>malloc(num_out_weights * sizeof(double))
 ...
 */
    ...
    __pyx_t_13 = -1;
    if (__pyx_t_12 < 0) {
      __pyx_t_12 += __pyx_pybuffernd_rnd_num.diminfo[0].shape;
      if (unlikely(__pyx_t_12 < 0)) __pyx_t_13 = 0;
    } else if (unlikely(__pyx_t_12 >= __pyx_pybuffernd_rnd_num.diminfo[0].shape)) __pyx_t_13 = 0;
    if (unlikely(__pyx_t_13 != -1)) {
      __Pyx_RaiseBufferIndexError(__pyx_t_13);
      __PYX_ERR(0, 13, __pyx_L1_error)
    }
    (__pyx_v_neu.out_weights[__pyx_v_i]) = (*__Pyx_BufPtrCContig1d(__pyx_t_8topology_8topology_DOUBLE_t *, __pyx_pybuffernd_rnd_num.rcbuffer->pybuffer.buf, __pyx_t_12, __pyx_pybuffernd_rnd_num.diminfo[0].strides));
  }

  /* "topology/topology.pyx":14
 *     for i in range(num_out_weights):
 *         neu.out_weights[i] = rnd_num[i]
 *     neu.dw = <double*>malloc(num_out_weights * sizeof(double))             # <<<<<<<<<<<<<<
 *     for i in range(num_out_weights):
 *         neu.dw[i] = 0.
 */
  __pyx_v_neu.dw = ((double *)malloc((__pyx_v_num_out_weights * (sizeof(double)))));

  /* "topology/topology.pyx":15
 *         neu.out_weights[i] = rnd_num[i]
 *     neu.dw = <double*>malloc(num_out_weights * sizeof(double))
 *     for i in range(num_out_weights):             # <<<<<<<<<<<<<<
 *         neu.dw[i] = 0.
 ...
 *     neu.dbias = 0.
 */
    (__pyx_v_neu.dw[__pyx_v_i]) = 0.;
  }

  /* "topology/topology.pyx":17
 *     for i in range(num_out_weights):
 *         neu.dw[i] = 0.
 *     neu.bias = rnd_num[num_out_weights]             # <<<<<<<<<<<<<<
 *     neu.dbias = 0.
 *     #####################################
 */
  __pyx_t_12 = __pyx_v_num_out_weights;
  __pyx_t_6 = -1;
  if (__pyx_t_12 < 0) {
    __pyx_t_12 += __pyx_pybuffernd_rnd_num.diminfo[0].shape;
    if (unlikely(__pyx_t_12 < 0)) __pyx_t_6 = 0;
  } else if (unlikely(__pyx_t_12 >= __pyx_pybuffernd_rnd_num.diminfo[0].shape)) __pyx_t_6 = 0;
  if (unlikely(__pyx_t_6 != -1)) {
    __Pyx_RaiseBufferIndexError(__pyx_t_6);
    __PYX_ERR(0, 17, __pyx_L1_error)
  }
  __pyx_v_neu.bias = (*__Pyx_BufPtrCContig1d(__pyx_t_8topology_8topology_DOUBLE_t *, __pyx_pybuffernd_rnd_num.rcbuffer->pybuffer.buf, __pyx_t_12, __pyx_pybuffernd_rnd_num.diminfo[0].strides));

  /* "topology/topology.pyx":18
 *         neu.dw[i] = 0.
 *     neu.bias = rnd_num[num_out_weights]
 *     neu.dbias = 0.             # <<<<<<<<<<<<<<
 *     #####################################
 ...
 */
  ...
  __Pyx_WriteUnraisable("topology.topology.create_neuron", __pyx_clineno, __pyx_lineno, __pyx_filename, 1, 0);
  __Pyx_pretend_to_initialize(&__pyx_r);
  goto __pyx_L2;
  __pyx_L0:;
  __Pyx_SafeReleaseBuffer(&__pyx_pybuffernd_rnd_num.rcbuffer->pybuffer);
  __pyx_L2:;
  __Pyx_XDECREF((PyObject *)__pyx_v_rnd_num);
  __Pyx_RefNannyFinishContext();
  return __pyx_r;
}

/* "topology/topology.pyx":26
 *     return neu
 * 
 * cdef layer_t create_layer(int num_of_neurons, f_type activation_f, f_type derivative_f):             # <<<<<<<<<<<<<<
 *     cdef layer_t lay
...
static struct __pyx_t_8topology_8topology_layer_t __pyx_f_8topology_8topology_create_layer(int __pyx_v_num_of_neurons, __pyx_t_8topology_8topology_f_type __pyx_v_activation_f, __pyx_t_8topology_8topology_f_type __pyx_v_derivative_f) {
  struct __pyx_t_8topology_8topology_layer_t __pyx_v_lay;
  struct __pyx_t_8topology_8topology_layer_t __pyx_r;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("create_layer", 0);

  /* "topology/topology.pyx":28
 * cdef layer_t create_layer(int num_of_neurons, f_type activation_f, f_type derivative_f):
 *     cdef layer_t lay
 *     lay.num_neu = num_of_neurons             # <<<<<<<<<<<<<<
 ...
 */
  __pyx_v_lay.num_neu = __pyx_v_num_of_neurons;

  /* "topology/topology.pyx":29
 *     cdef layer_t lay
 *     lay.num_neu = num_of_neurons
 *     lay.activation_f = activation_f             # <<<<<<<<<<<<<<
 *     lay.derivative_f = derivative_f
 ...
 */
  __pyx_v_lay.activation_f = __pyx_v_activation_f;

  /* "topology/topology.pyx":30
 *     lay.num_neu = num_of_neurons
 *     lay.activation_f = activation_f
 *     lay.derivative_f = derivative_f             # <<<<<<<<<<<<<<
 *     lay.neu = <neuron_t*>malloc(num_of_neurons * sizeof(neuron_t))
 *     return lay
 */
  __pyx_v_lay.derivative_f = __pyx_v_derivative_f;

  /* "topology/topology.pyx":31
 *     lay.activation_f = activation_f
 *     lay.derivative_f = derivative_f
 *     lay.neu = <neuron_t*>malloc(num_of_neurons * sizeof(neuron_t))             # <<<<<<<<<<<<<<
 *     return lay
 * 
 */
  __pyx_v_lay.neu = ((struct __pyx_t_8topology_8topology_neuron_t *)malloc((__pyx_v_num_of_neurons * (sizeof(struct __pyx_t_8topology_8topology_neuron_t)))));

  /* "topology/topology.pyx":32
 *     lay.derivative_f = derivative_f
 *     lay.neu = <neuron_t*>malloc(num_of_neurons * sizeof(neuron_t))
 *     return lay             # <<<<<<<<<<<<<<
 * 
...
static struct __pyx_t_8topology_8topology_network_t __pyx_f_8topology_8topology_create_network(__Pyx_memviewslice __pyx_v_structure, PyArrayObject *__pyx_v_activations, double __pyx_v_eta, double __pyx_v_w_init, double __pyx_v_alpha, double __pyx_v_l) {
  int __pyx_v_num_of_layers;
  int __pyx_v_i;
  int __pyx_v_j;
 ...
 *     cdef network_t net
 */
  __pyx_t_1 = __Pyx_MemoryView_Len(__pyx_v_structure); 
  __pyx_v_num_of_layers = __pyx_t_1;

  /* "topology/topology.pyx":38
 *     cdef int i, j
 *     cdef network_t net
 ...
 *     net.l = l
 */
  __pyx_v_net.num_layers = __pyx_v_num_of_layers;

  /* "topology/topology.pyx":39
 *     cdef network_t net
 *     net.num_layers = num_of_layers
 *     net.eta = eta             # <<<<<<<<<<<<<<
 *     net.l = l
 *     net.alpha = alpha
 */
  __pyx_v_net.eta = __pyx_v_eta;

  /* "topology/topology.pyx":40
 *     net.num_layers = num_of_layers
 *     net.eta = eta
 *     net.l = l             # <<<<<<<<<<<<<<
 *     net.alpha = alpha
 *     # allocate memory
 */
  __pyx_v_net.l = __pyx_v_l;

  /* "topology/topology.pyx":41
 *     net.eta = eta
 *     net.l = l
 *     net.alpha = alpha             # <<<<<<<<<<<<<<
 *     # allocate memory
 ...
 */
  __pyx_v_net.alpha = __pyx_v_alpha;

  /* "topology/topology.pyx":43
 *     net.alpha = alpha
 *     # allocate memory
 *     net.lay = <layer_t*>malloc(num_of_layers * sizeof(layer_t))             # <<<<<<<<<<<<<<
 ...
 */
  __pyx_v_net.lay = ((struct __pyx_t_8topology_8topology_layer_t *)malloc((__pyx_v_num_of_layers * (sizeof(struct __pyx_t_8topology_8topology_layer_t)))));

  /* "topology/topology.pyx":45
 *     net.lay = <layer_t*>malloc(num_of_layers * sizeof(layer_t))
 *     # middle layers/neurons
 *     for i in range(num_of_layers-1):             # <<<<<<<<<<<<<<
 ...
 */
  __pyx_t_2 = (__pyx_v_num_of_layers - 1);
  __pyx_t_3 = __pyx_t_2;
  for (__pyx_t_4 = 0; __pyx_t_4 < __pyx_t_3; __pyx_t_4+=1) {
    __pyx_v_i = __pyx_t_4;

    /* "topology/topology.pyx":46
 *     # middle layers/neurons
 *     for i in range(num_of_layers-1):
 *         if activations[i] == 'sigmoid':             # <<<<<<<<<<<<<<
 *             net.lay[i] = create_layer(structure[i], sigmoid, sigmoid_der)
 ...
 */
    __pyx_t_5 = __Pyx_GetItemInt(((PyObject *)__pyx_v_activations), __pyx_v_i, int, 1, __Pyx_PyInt_From_int, 0, 1, 1); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 46, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_5);
    __pyx_t_6 = (__Pyx_PyString_Equals(__pyx_t_5, __pyx_n_s_sigmoid, Py_EQ)); if (unlikely(__pyx_t_6 < 0)) __PYX_ERR(0, 46, __pyx_L1_error)
    __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
    if (__pyx_t_6) {

      /* "topology/topology.pyx":47
 *     for i in range(num_of_layers-1):
 *         if activations[i] == 'sigmoid':
 *             net.lay[i] = create_layer(structure[i], sigmoid, sigmoid_der)             # <<<<<<<<<<<<<<
 *         elif activations[i] == 'linear':
 ...
 */
      ...
      __pyx_t_8 = -1;
      if (__pyx_t_7 < 0) {
        __pyx_t_7 += __pyx_v_structure.shape[0];
        if (unlikely(__pyx_t_7 < 0)) __pyx_t_8 = 0;
      } else if (unlikely(__pyx_t_7 >= __pyx_v_structure.shape[0])) __pyx_t_8 = 0;
      if (unlikely(__pyx_t_8 != -1)) {
        __Pyx_RaiseBufferIndexError(__pyx_t_8);
        __PYX_ERR(0, 47, __pyx_L1_error)
      }
      (__pyx_v_net.lay[__pyx_v_i]) = __pyx_f_8topology_8topology_create_layer((*((int *) ( /* dim=0 */ (__pyx_v_structure.data + __pyx_t_7 * __pyx_v_structure.strides[0]) ))), __pyx_f_11activations_11activations_sigmoid, __pyx_f_11activations_11activations_sigmoid_der);
 ...
 */
    __pyx_t_5 = __Pyx_GetItemInt(((PyObject *)__pyx_v_activations), __pyx_v_i, int, 1, __Pyx_PyInt_From_int, 0, 1, 1); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 48, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_5);
    __pyx_t_6 = (__Pyx_PyString_Equals(__pyx_t_5, __pyx_n_s_linear, Py_EQ)); if (unlikely(__pyx_t_6 < 0)) __PYX_ERR(0, 48, __pyx_L1_error)
    __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
    if (__pyx_t_6) {

      /* "topology/topology.pyx":49
 *             net.lay[i] = create_layer(structure[i], sigmoid, sigmoid_der)
 *         elif activations[i] == 'linear':
 *             net.lay[i] = create_layer(structure[i], lin, lin_der)             # <<<<<<<<<<<<<<
 *         else: print('Activation func not valid')
 ...
 */
      ...
      (__pyx_v_net.lay[__pyx_v_i]) = __pyx_f_8topology_8topology_create_layer((*((int *) ( /* dim=0 */ (__pyx_v_structure.data + __pyx_t_7 * __pyx_v_structure.strides[0]) ))), __pyx_f_11activations_11activations_lin, __pyx_f_11activations_11activations_lin_der);
 ...
 */
    /*else*/ {
      if (__Pyx_PrintOne(0, __pyx_kp_s_Activation_func_not_valid) < 0) __PYX_ERR(0, 50, __pyx_L1_error)
    }
    __pyx_L5:;

    /* "topology/topology.pyx":51
 *             net.lay[i] = create_layer(structure[i], lin, lin_der)
 *         else: print('Activation func not valid')
 *         for j in range(structure[i]):             # <<<<<<<<<<<<<<
 *             net.lay[i].neu[j] = create_neuron(structure[i+1], w_init)
 ...
 */
    ...
    __pyx_t_8 = (*((int *) ( /* dim=0 */ (__pyx_v_structure.data + __pyx_t_7 * __pyx_v_structure.strides[0]) )));
    __pyx_t_9 = __pyx_t_8;
    for (__pyx_t_10 = 0; __pyx_t_10 < __pyx_t_9; __pyx_t_10+=1) {
      __pyx_v_j = __pyx_t_10;

      /* "topology/topology.pyx":52
 *         else: print('Activation func not valid')
 *         for j in range(structure[i]):
 *             net.lay[i].neu[j] = create_neuron(structure[i+1], w_init)             # <<<<<<<<<<<<<<
 * 
 ...
 */
      ...
      } else if (unlikely(__pyx_t_7 >= __pyx_v_structure.shape[0])) __pyx_t_11 = 0;
      if (unlikely(__pyx_t_11 != -1)) {
        __Pyx_RaiseBufferIndexError(__pyx_t_11);
        __PYX_ERR(0, 52, __pyx_L1_error)
      }
      ((__pyx_v_net.lay[__pyx_v_i]).neu[__pyx_v_j]) = __pyx_f_8topology_8topology_create_neuron((*((int *) ( /* dim=0 */ (__pyx_v_structure.data + __pyx_t_7 * __pyx_v_structure.strides[0]) ))), __pyx_v_w_init);
    }
  }

  /* "topology/topology.pyx":55
 * 
 *     # Outer layers/neuron
 ...
 */
  __pyx_t_2 = (__pyx_v_num_of_layers - 1);
  __pyx_t_5 = __Pyx_GetItemInt(((PyObject *)__pyx_v_activations), __pyx_t_2, long, 1, __Pyx_PyInt_From_long, 0, 1, 1); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 55, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_5);
  __pyx_t_6 = (__Pyx_PyString_Equals(__pyx_t_5, __pyx_n_s_sigmoid, Py_EQ)); if (unlikely(__pyx_t_6 < 0)) __PYX_ERR(0, 55, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
  if (__pyx_t_6) {

    /* "topology/topology.pyx":56
 *     # Outer layers/neuron
 *     if activations[num_of_layers-1] == 'sigmoid':
 *         net.lay[num_of_layers-1] = create_layer(structure[num_of_layers-1], sigmoid, sigmoid_der)             # <<<<<<<<<<<<<<
 *     elif activations[num_of_layers-1] == 'linear':
 ...
 */
    __pyx_t_7 = (__pyx_v_num_of_layers - 1);
    __pyx_t_4 = -1;
    if (__pyx_t_7 < 0) {
      __pyx_t_7 += __pyx_v_structure.shape[0];
      if (unlikely(__pyx_t_7 < 0)) __pyx_t_4 = 0;
    } else if (unlikely(__pyx_t_7 >= __pyx_v_structure.shape[0])) __pyx_t_4 = 0;
    if (unlikely(__pyx_t_4 != -1)) {
      __Pyx_RaiseBufferIndexError(__pyx_t_4);
      __PYX_ERR(0, 56, __pyx_L1_error)
    }
    (__pyx_v_net.lay[(__pyx_v_num_of_layers - 1)]) = __pyx_f_8topology_8topology_create_layer((*((int *) ( /* dim=0 */ (__pyx_v_structure.data + __pyx_t_7 * __pyx_v_structure.strides[0]) ))), __pyx_f_11activations_11activations_sigmoid, __pyx_f_11activations_11activations_sigmoid_der);
 ...
 */
  __pyx_t_2 = (__pyx_v_num_of_layers - 1);
  __pyx_t_5 = __Pyx_GetItemInt(((PyObject *)__pyx_v_activations), __pyx_t_2, long, 1, __Pyx_PyInt_From_long, 0, 1, 1); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 57, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_5);
  __pyx_t_6 = (__Pyx_PyString_Equals(__pyx_t_5, __pyx_n_s_linear, Py_EQ)); if (unlikely(__pyx_t_6 < 0)) __PYX_ERR(0, 57, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
  if (__pyx_t_6) {

    /* "topology/topology.pyx":58
 *         net.lay[num_of_layers-1] = create_layer(structure[num_of_layers-1], sigmoid, sigmoid_der)
 *     elif activations[num_of_layers-1] == 'linear':
 *         net.lay[num_of_layers-1] = create_layer(structure[num_of_layers-1], lin, lin_der)             # <<<<<<<<<<<<<<
 *     else: print('Activation func not valid')
 ...
 */
    ...
    (__pyx_v_net.lay[(__pyx_v_num_of_layers - 1)]) = __pyx_f_8topology_8topology_create_layer((*((int *) ( /* dim=0 */ (__pyx_v_structure.data + __pyx_t_7 * __pyx_v_structure.strides[0]) ))), __pyx_f_11activations_11activations_lin, __pyx_f_11activations_11activations_lin_der);
 ...
 */
  /*else*/ {
    if (__Pyx_PrintOne(0, __pyx_kp_s_Activation_func_not_valid) < 0) __PYX_ERR(0, 59, __pyx_L1_error)
  }
  __pyx_L8:;

  /* "topology/topology.pyx":60
 *         net.lay[num_of_layers-1] = create_layer(structure[num_of_layers-1], lin, lin_der)
 *     else: print('Activation func not valid')
 *     for i in range(structure[num_of_layers-1]):             # <<<<<<<<<<<<<<
 *         net.lay[num_of_layers-1].neu[i] = create_neuron(1, w_init)
 ...
 */
  ...
  __pyx_t_4 = (*((int *) ( /* dim=0 */ (__pyx_v_structure.data + __pyx_t_7 * __pyx_v_structure.strides[0]) )));
  __pyx_t_8 = __pyx_t_4;
  for (__pyx_t_9 = 0; __pyx_t_9 < __pyx_t_8; __pyx_t_9+=1) {
    __pyx_v_i = __pyx_t_9;

    /* "topology/topology.pyx":61
 *     else: print('Activation func not valid')
 *     for i in range(structure[num_of_layers-1]):
 *         net.lay[num_of_layers-1].neu[i] = create_neuron(1, w_init)             # <<<<<<<<<<<<<<
 *     return net
 * 
 */
    ((__pyx_v_net.lay[(__pyx_v_num_of_layers - 1)]).neu[__pyx_v_i]) = __pyx_f_8topology_8topology_create_neuron(1, __pyx_v_w_init);
  }

  /* "topology/topology.pyx":62
 *     for i in range(structure[num_of_layers-1]):
 *         net.lay[num_of_layers-1].neu[i] = create_neuron(1, w_init)
 *     return net             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  __Pyx_WriteUnraisable("topology.topology.create_network", __pyx_clineno, __pyx_lineno, __pyx_filename, 1, 0);
  __Pyx_pretend_to_initialize(&__pyx_r);
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  return __pyx_r;
...
static PyTypeObject __pyx_type___pyx_array = {
  ...
  "topology.topology.array", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_MemviewEnum = {
  PyVarObject_HEAD_INIT(0, 0)
  "topology.topology.Enum", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryview = {
  PyVarObject_HEAD_INIT(0, 0)
  "topology.topology.memoryview", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryviewslice = {
  PyVarObject_HEAD_INIT(0, 0)
  "topology.topology._memoryviewslice", /*tp_name*/
...
static __Pyx_StringTabEntry __pyx_string_tab[] = {
  ...
  {&__pyx_kp_s_Activation_func_not_valid, __pyx_k_Activation_func_not_valid, sizeof(__pyx_k_Activation_func_not_valid), 0, 0, 1, 0},
...
static int __Pyx_modinit_function_export_code(void) {
  ...
  if (__Pyx_ExportFunction("create_neuron", (void (*)(void))__pyx_f_8topology_8topology_create_neuron, "struct __pyx_t_8topology_8topology_neuron_t (int, double)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("create_layer", (void (*)(void))__pyx_f_8topology_8topology_create_layer, "struct __pyx_t_8topology_8topology_layer_t (int, __pyx_t_8topology_8topology_f_type, __pyx_t_8topology_8topology_f_type)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("create_network", (void (*)(void))__pyx_f_8topology_8topology_create_network, "struct __pyx_t_8topology_8topology_network_t (__Pyx_memviewslice, PyArrayObject *, double, double, double, double)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  __Pyx_RefNannyFinishContext();
  return 0;
  __pyx_L1_error:;
  __Pyx_RefNannyFinishContext();
...
if (!__Pyx_RefNanny) {
  ...
  #endif
  if (__pyx_module_is_main_topology__topology) {
    if (PyObject_SetAttr(__pyx_m, __pyx_n_s_name_2, __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "topology.topology")) {
      if (unlikely(PyDict_SetItemString(modules, "topology.topology", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init topology.topology", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_CLEAR(__pyx_m);
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init topology.topology");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
